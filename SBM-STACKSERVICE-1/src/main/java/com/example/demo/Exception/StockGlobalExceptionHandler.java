...
public class StockGlobalExceptionHandler {
	...
	@ExceptionHandler(ComapanyInfoNotFoundException.class)
	public ResponseEntity<String> stockIsNotFound(ComapanyInfoNotFoundException c) {
		return new ResponseEntity<>("<!--\r\n"
				...
				+ "                <h2 >HEY BABA!, YOU'RE SEARCHING COMPANY IS NOT FOUND IN THE BSE (OR) NSE NOT MAINTAING DATA.</h2>\r\n"
				+ "                <a href=\"http://localhost:9999/stockprice/101\" class=\"btn-go-home\" target=\"_self\">GO BACK HOME</a>\r\n"
				+ "            </div>\r\n"
				+ "            <div class=\"objects\">\r\n"
